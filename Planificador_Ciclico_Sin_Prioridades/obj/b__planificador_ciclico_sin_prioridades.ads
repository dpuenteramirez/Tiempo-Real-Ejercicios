...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_planificador_ciclico_sin_prioridades" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d185551d#;
   pragma Export (C, u00001, "planificador_ciclico_sin_prioridadesB");
   ...
   --  planificador_ciclico_sin_prioridades%b
